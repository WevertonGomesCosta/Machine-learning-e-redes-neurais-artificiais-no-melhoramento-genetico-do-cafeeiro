...
# Seleção Genõmica Ampla - Dados Reais (Coffea arabica)
...
## 3. Modelos Mistos para Seleção Genômica Ampla (GWS)
...
Os resultados mostraram que o modelo GBLUP_ADE obteve o melhor desempenho em termos de R² e RMSE para a maioria dos traços, seguido pelo modelo MARS_3. O modelo MARS_1 apresentou desempenho inferior, especialmente em traços com alta complexidade genética. O Decision Tree e o Bagging também mostraram resultados competitivos, enquanto o Random Forest teve um desempenho semelhante ao GBLUP_ADE. O Boosting (GBM) e o Perceptron Multicamadas (PMC) apresentaram resultados variados, dependendo do traço analisado.

## 5. Conclusão

Neste estudo, avaliamos o desempenho de diferentes métodos de predição genômica em um conjunto de dados real de _Cofea arabica_ Os resultados mostraram que o GBLUP_ADE foi o método mais eficaz, seguido pelo MARS_3. O Decision Tree e o Bagging também se destacaram, enquanto o Random Forest teve desempenho semelhante ao GBLUP_ADE. O Boosting (GBM) e o Perceptron Multicamadas (PMC) apresentaram resultados variados, dependendo do traço analisado.
