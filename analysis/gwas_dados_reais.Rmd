...
## 2. Preparação dos dados Fenótipicos e Genótipicos
...
### 3.1 Preparar os dados de genótipo e mapa
...
### 3.2 Run LD decay analysis for each linkage group
...
```{r plot-ld-save, include = FALSE, eval = FALSE}
...
### Loop para executar GAPIT em paralelo
...
## 5. Importância de Marcadores via Modelos de ML
...
models <- c("MARS_1", "MARS_2", "MARS_3", "DT", "Bag", "RF", "GBM")
paths  <- paste0("output/real_results_cv_", models, ".rds")

# Combina todas as tabelas num único data.frame
imp_ML <- map2_dfr(paths, models, flatten_importance)
...
## 6. Combinação de GWAS e Importância
...
## 7. Pós-processamento e Exemplo de Plot
...
### 7.3 Definindo os marcadores signifciativos
...
```{r manhatan-plot, message=FALSE, warning=FALSE, out.width='100%', height = 20}
for (i in traits) {
